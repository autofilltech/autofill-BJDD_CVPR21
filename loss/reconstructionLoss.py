...
class ReconstructionLoss(nn.Module):
	...
	def __call__(self, x, y): # x = [B, 1, H, W] y = [B, 12, H, W]
		...
		gb = torch.stack((y[:,1,2::4,0::4], y[:,4,2::4, 1::4], y[:,7,3::4,0::4], y[:,10,3::4,1::4]), 1)
		bb = torch.stack((y[:,2,2::4,2::4], y[:,5,2::4, 3::4], y[:,8,3::4,2::4], y[:,11,3::4,3::4]), 1)
		...
		predRaw = nn.PixelShuffle(4)(torch.stack((
			...
			predRaw[:,10], predRaw[:,11,:,:], predRaw[:,14,:,:], predRaw[:,15,:,:]),1))
